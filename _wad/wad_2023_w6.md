...
为方便观看，你可以
<button onclick="window.location.href='https:\/\/robinlee19.lanzout.com/iAiyL1c5vwpc'" style="background-color:#63B5D3; color:#ffffff; font-size:24px; border-radius:5px; border:0px solid; padding:8px 10px">获取打印版题目</button> 或
...
3. 首先规定三个基本操作：“中点→平行”、“平行→中点”与“单尺作中垂线”。
   ...
   ![图 4](./img/wad_2023_w6_mth_pic4.png)
